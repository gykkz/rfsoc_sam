...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_net -net M01_ACLK_1 [get_bd_pins M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins channel_30/AXI4_Lite_ACLK] [get_bd_pins channel_32/AXI4_Lite_ACLK]
  connect_bd_net -net M01_ARESETN_1 [get_bd_pins M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins channel_30/AXI4_Lite_ARESETN] [get_bd_pins channel_32/AXI4_Lite_ARESETN]
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins channel_20/AXI4_Lite_ARESETN] [get_bd_pins channel_22/AXI4_Lite_ARESETN]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins M00_ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins channel_20/AXI4_Lite_ACLK] [get_bd_pins channel_22/AXI4_Lite_ACLK]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.DAC3_Fabric_Freq {153.600} \
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins vin1_01] [get_bd_intf_pins rfdc/vin10]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins vin1_23] [get_bd_intf_pins rfdc/vin11]
  ...
  connect_bd_intf_net -intf_net rfdc_vout21 [get_bd_intf_pins vout22] [get_bd_intf_pins rfdc/vout21]
  connect_bd_intf_net -intf_net rfdc_vout31 [get_bd_intf_pins vout32] [get_bd_intf_pins rfdc/vout31]
  ...
  connect_bd_intf_net -intf_net vin0_01_1 [get_bd_intf_pins vin0_01] [get_bd_intf_pins rfdc/vin00]
  connect_bd_intf_net -intf_net vin0_23_1 [get_bd_intf_pins vin0_23] [get_bd_intf_pins rfdc/vin01]
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac2/peripheral_aresetn] [get_bd_pins rfdc/s2_axis_aresetn] [get_bd_pins transmitter/M00_ARESETN]
  connect_bd_net -net proc_sys_reset_clk_dac2_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac3/peripheral_aresetn] [get_bd_pins rfdc/s3_axis_aresetn] [get_bd_pins transmitter/M01_ARESETN]
  connect_bd_net -net rfdc_clk_dac3 [get_bd_pins proc_sys_reset_clk_dac3/slowest_sync_clk] [get_bd_pins rfdc/clk_dac3] [get_bd_pins rfdc/s3_axis_aclk] [get_bd_pins transmitter/M01_ACLK]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins proc_sys_reset_clk_adc1/slowest_sync_clk] [get_bd_pins receiver/S02_ACLK] [get_bd_pins rfdc/clk_adc1] [get_bd_pins rfdc/m1_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins proc_sys_reset_clk_dac2/slowest_sync_clk] [get_bd_pins rfdc/clk_dac2] [get_bd_pins rfdc/s2_axis_aclk] [get_bd_pins transmitter/M00_ACLK]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_20/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_30/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_32/control/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_12/decimator/xsg_bwselector_s_axi/reg0] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_10/spectrum_analyser/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_12/spectrum_analyser/AXI4_Lite/reg0] -force
